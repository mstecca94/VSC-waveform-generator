...
for xx = 1:size(Wave.Input.ModulationStrategies,2)
    ...
    ModComparison(xx).Wave = Wave ;
    ModComparison(xx).WaveR = WaveR ;
...
hold on
for xx = 1:size(Wave.Input.ModulationStrategies,2)
    plot(Wave.Input.P_range/Wave.Input.Pmax,ModComparison(xx).WaveR.Converter.Efficiency)
end
...
hold on
for xx = 1:size(Wave.Input.ModulationStrategies,2)
    scatter(ModComparison(xx).Wave.System.Cost,ModComparison(xx).Wave.System.Efficiency,[],...
        ModComparison(xx).Wave.System.Weight,'filled')
end
legend(char(Wave.Input.ModulationStrategies))
grid on
xlabel('Cost [€]')
...
hold on
for xx = 1:size(Wave.Input.ModulationStrategies,2)
    scatter(ModComparison(xx).Wave.System.CostperkW,ModComparison(xx).Wave.System.Efficiency,[],...
        ModComparison(xx).Wave.System.PowerDensity,'filled')
end
legend(char(Wave.Input.ModulationStrategies))
grid on
...
for xx = 1:size(Wave.Input.ModulationStrategies,2)
    ...
    scatter(ModComparison(xx).Wave.System.Cost,ModComparison(xx).Wave.System.Efficiency)
    text(ModComparison(xx).Wave.System.Cost-100,ModComparison(xx).Wave.System.Efficiency+0.04*1*sign(xy)...
        ,sprintf('%s',char(Wave.Input.ModulationStrategies(xx))))
    text(ModComparison(xx).Wave.System.Cost-50,ModComparison(xx).Wave.System.Efficiency+0.02*1*sign(xy)...
        ,sprintf('{%.1f kg}',ModComparison(xx).Wave.System.Weight))
end
legend(char(Wave.Input.ModulationStrategies))
grid on
xlabel('Cost [euro]')
...
for xx = 1:size(Wave.Input.ModulationStrategies,2)
    ...
    scatter(ModComparison(xx).Wave.System.CostperkW,ModComparison(xx).Wave.System.Efficiency)
    text(ModComparison(xx.Wave.System.CostperkW-1.5,ModComparison(xx).Wave.System.Efficiency+0.04*1*sign(xy)...
        ,sprintf('%s',char(Wave.Input.ModulationStrategies(xx))))
    text(ModComparison(xx).Wave.System.CostperkW-0.75,ModComparison(xx).Wave.System.Efficiency+0.02*1*sign(xy)...
        ,sprintf('{%.1f kW/kg}',ModComparison(xx).Wave.System.PowerDensity))
end
legend(char(Wave.Input.ModulationStrategies))
grid on
xlabel('Cost  per kW [€/kW]')
