function [ Wave , Temp ] = current_with_ripple_LCL ( Wave , Temp )
...
%% save data
Temp.i_converter_side = i1_wave; 
Temp.i_grid_side = i2_wave;

Temp.i_converter_side_dmpd = i1_wave_dmpd ; 
Temp.i_grid_side_dmpd = i2_wave_dmpd ; 
