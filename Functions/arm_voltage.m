...
if Wave.Input.plot_arm_volt == 1
    ...
    subplot(3,1,1)
    hold on
    title('Line-to-line AB Voltage')
    plot(t,v_ab,'b','LineWidth',lw)
    plot(t,Vgab,'r','LineWidth',lw)
    xlabel('Time [s]')
    ylabel('Voltage [V]')
    grid on

    subplot(3,1,2)
    title('Line-to-line BC Voltage')
    hold on
    plot(t,v_bc,'b','LineWidth',lw)
    plot(t,Vgbc,'r','LineWidth',lw)
    xlabel('Time [s]')
    ylabel('Voltage [V]')
    grid on

    subplot(3,1,3)
    title('Line-to-line CA Voltage')
    hold on
    plot(t,v_ca,'b','LineWidth',lw)
    plot(t,Vgca,'r','LineWidth',lw)
    xlabel('Time [s]')
    ylabel('Voltage [V]')
    grid on
    ...
    case {'Two Level','Two Level - SiC'}
%             figure;
%             sgtitle('Current in semiconductor')
%             hold on
%             plot(t(i_T1(:)~=0),i_T1(i_T1(:)~=0),'b','LineWidth',lw)
%             plot(t(i_T2(:)~=0),i_T2(i_T2(:)~=0),'--b','LineWidth',lw)
%             plot(t(i_D1(:)~=0),i_D1(i_D1(:)~=0),'--r','LineWidth',lw)
%             plot(t(i_D2(:)~=0),i_D2(i_D2(:)~=0),'r','LineWidth',lw)
%             grid on
% 
%             figure;
%             sgtitle('Current in semiconductor')
%             hold on
%             subplot(4,1,1)
%             plot(t,i_T1,'b','LineWidth',lw)
%             xlabel('Time [s]')
%             ylabel('Current [A]')
%             grid on
%             
%             subplot(4,1,2)
%             plot(t,i_T2,'b','LineWidth',lw)
%             xlabel('Time [s]')
%             ylabel('Current [A]')
%             grid on
%             
%             subplot(4,1,3)
%             plot(t,i_D1,'r','LineWidth',lw)
%             grid on
%             xlabel('Time [s]')
%             ylabel('Current [A]')
%             
%             subplot(4,1,4)
%             plot(t,i_D2,'r','LineWidth',lw)
%             grid on
%             xlabel('Time [s]')
%             ylabel('Current [A]')
        case 'Three Level NPC'
...
%             hold on
%             plot(t,i_T1,'b','LineWidth',lw)
%             plot(t,i_T2,'x--b','LineWidth',lw)
%             plot(t,i_D1,'r','LineWidth',lw)
%             plot(t,i_D2,'x--r','LineWidth',lw)
%             plot(t,i_T3,'g','LineWidth',lw)
%             plot(t,i_T4,'','LineWidth',lw)
%             plot(t,i_D3,'--r','LineWidth',lw)
%             plot(t,i_D4,'r','LineWidth',lw)
%             legend('D2','D3')
%             grid on
% 
%             figure;
...
%             subplot(5,1,5)
%             hold on
%             plot(t,i_D5,'b','LineWidth',lw)
%             plot(t,i_D6,'r','LineWidth',lw)
%             legend('D5','D6')
%             grid on
%             xlabel('Time [s]')
%             ylabel('Current [A]')
