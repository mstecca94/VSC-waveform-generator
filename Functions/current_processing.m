...
switch Topology 
    case 'Two Level'
            Wave.SemiconductorLosses.I_T1_avg =  mean(abs(Wave.Current.i_T1/nps))*2 ;
            Wave.SemiconductorLosses.I_D1_avg = mean(abs(Wave.Current.i_D1))*2 ;

            Wave.SemiconductorLosses.I_T1_rms = rms(Wave.Current.i_T1/nps)*sqrt(2) ;
            Wave.SemiconductorLosses.I_D1_rms = rms(Wave.Current.i_D1)*sqrt(2) ;
            if Add_LCL == 1
                Wave.SemiconductorLosses.I_T1_wr_avg = mean(abs(Wave.CurrentWR.i_T1_wr/nps))*2 ;
                Wave.SemiconductorLosses.I_D1_wr_avg = mean(abs(Wave.CurrentWR.i_D1_wr))*2 ;

                Wave.SemiconductorLosses.I_T1_wr_rms = rms(Wave.CurrentWR.i_T1_wr/nps)*sqrt(2) ;
