function [ Wave ] = summary_routine ( Wave )
...
%     disp('-----Custom DC link design-----')
%     fprintf('M range %.3f %.3f\n',Wave.DClink.M_range(1),Wave.DClink.M_range(end))
%     fprintf('Phi range %.3f %.3f\n',Wave.Input.phimin,Wave.Input.phimax)
%     fprintf('Selected Design %s\n',Wave.Input.DC_Design)
% else
%     disp('-----Pre made DC link design-----')
% end
% fprintf('%d parallel strings of 2 500VDC %d uF capacitors \n',...
%     Wave.DClink.Design(8),Wave.DClink.Design(1))
% fprintf('weight %.3f kg / volume %.3f m3 / cost %.3f k€ \n\n',...
%     Wave.DClink.Design(10),Wave.DClink.Design(11),Wave.DClink.Design(12))
