...
for yy = 1:size(ModComparison(1,1,1).Wave.Input.phi_range,2)
    ...
    Cond_MSLDPWM(yy,zz)= ModComparison(3,yy,zz).Wave.Losses.Pc_tot*3;
    Sw_MSLDPWM(yy,zz)= ModComparison(3,yy,zz).Wave.Losses.Ps_tot*3;
    Eff_MSLDPWM(yy,zz)= ModComparison(3,yy,zz).Wave.Losses.Efficiency;
end
end
