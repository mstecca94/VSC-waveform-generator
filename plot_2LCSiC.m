...
for xx = 1:size(ModComparison(1,1,1).Wave.Input.ModulationStrategies,2)
    ...
    elseif strcmp(ModComparison(xx,yy,zz).Wave.Input.Topology,'Two Level - SiC') == 1
        scatter(xx,...
            ModComparison(xx,yy,zz).Wave.Losses.Efficiency,[],...
            ModComparison(xx,yy,zz).Wave.Input.fs/1000,'o','filled','LineWidth',lw)
        scatter(xx,...
            ModComparison(xx,yy,zz).Wave.System.Efficiency,100,...
            ModComparison(xx,yy,zz).Wave.Input.fs/1000,'p','filled','LineWidth',lw)
