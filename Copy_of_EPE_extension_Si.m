...
Wave.Input.plot_switching_energy = 1 ; % to plot interpolated switching energies
...
Wave.Input.plot_ESR_vs_f = 1 ; % to plot ESR vs f interpolation
Wave.Input.DClinkDesignPlotting = 1 ; % to plot DC link designs 
Wave.Input.Plot_DC_link_Current = 1 ; % to plot the DC link current for phi / M
Wave.Input.plot_InductorDesign = 1 ; % 1 to plot  the possible inducto designs
Wave.Input.AC_cap_plotting = 1 ; % 1 to plot the AC capacitor designs
Wave.Input.plot_AC_cost_interpolation = 1 ; % to plot the cost interpolation for AC Cap 
Wave.Input.plot_routine = 1 ; % to plot the routine results
...
Wave.Input.LVRT_maxI = Wave.Input.I*2.5;
