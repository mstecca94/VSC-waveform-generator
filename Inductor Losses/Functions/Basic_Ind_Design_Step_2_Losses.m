function [ Core , Converter ] = Basic_Ind_Design_Step_2_Losses ( Converter , Core )
...
% Converter Side Core Loss Calculation
    ...
    [coreloss_iGSEx, num_minorloop] = coreloss_iGSE_Losses(B_m,time,ko,alpha,beta);
    ...
    [ Core ] = Wdg_Loss_Analyt_Losses( Core );
    ...
    [ Core ] = Temperature_Calc_Losses( Core );
